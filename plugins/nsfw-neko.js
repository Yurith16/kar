...
let handler = async (m, { command, conn, usedPrefix }) => {
    ...
    if (!chat.nsfw) {
        ...
        return m.reply(`> 🔞 *𝙽𝚂𝙵𝚆 𝙳𝙴𝚂𝙰𝙲𝚃𝙸𝚅𝙰𝙳𝙾*\n> El burdel está cerrado, mi vida. No me tientes si no vas a abrirlo primero.\n> 🔥 Actívalo con: *${usedPrefix}on nsfw*`);
    }
    ...
    try {
        ...
        // 4. Lógica de selección sucesiva
        ...
        // Envío de la imagen con su drama correspondiente
        await conn.sendMessage(m.chat, { 
            image: { url: url }, 
            caption: `${pago.caption}\n\n_¿Te gusta lo que ves? Estas gatitas no muerden... a menos que se lo pidas._ 💋` 
        }, { quoted: m });
        ...
        console.error(e);
        await conn.sendMessage(m.chat, { react: { text: '❌', key: m.key } });
        m.reply('> 🥀 El destino no quiso que viéramos esto hoy... Inténtalo de nuevo, corazón.');
    }
};
