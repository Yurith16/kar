...
let handler = async (m, { command, conn, usedPrefix }) => {
    ...
    if (!chat.nsfw) {
        ...
        return m.reply(`> 🔞 *𝙽𝚂𝙵𝚆 𝙳𝙴𝚂𝙰𝙲𝚃𝙸𝚅𝙰𝙳𝙾*\n> 🌿 El burdel está cerrado por ahora, amor.\n> 🔥 Actívalo con: *${usedPrefix}on nsfw* si te atreves.`);
    }
    ...
    try {
        ...
        console.error(e);
        await conn.sendMessage(m.chat, { react: { text: '❌', key: m.key } });
        m.reply('> 🥀 La conexión falló... parece que el deseo es demasiado fuerte para mis circuitos hoy.');
    }
};
